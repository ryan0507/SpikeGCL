...
# TQDM_DISABLE=1 python3 -u main_dasgnn.py --dataset ogbn-arxiv --T $1 --outs 1 --hids 64 --threshold $2 --no_shuffle --bn --dropout 0. --neuron $3 --epochs 20
TQDM_DISABLE=1 python3 -u main_dasgnn.py --dataset ogbn-mag --T $1 --outs 8 --hids 64 --threshold $2 --no_shuffle --bn --dropout 0. --neuron $3 --epochs 20 --lr $4
